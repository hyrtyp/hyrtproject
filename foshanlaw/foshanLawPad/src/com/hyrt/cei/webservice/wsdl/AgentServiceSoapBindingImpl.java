...
public final class AgentServiceSoapBindingImpl {
	...
	public String getUserListByuserId(String rs) throws Exception{
		SoapObject _client = new SoapObject("", "getUserListByuserId");
		SoapSerializationEnvelope _envelope = new SoapSerializationEnvelope(
				SoapEnvelope.VER11);
		_envelope.bodyOut = _client;
		_client.addProperty("xmlStr", rs);
	...
	public String getUserListByuserId1(String rs) throws Exception{
		SoapObject _client = new SoapObject("", "getUserListByuserId1");
		SoapSerializationEnvelope _envelope = new SoapSerializationEnvelope(
				SoapEnvelope.VER11);
		_envelope.bodyOut = _client;
		_client.addProperty("xmlStr", rs);
