...
public class MainChoiceActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.icon_c:
			...
			break;
		case R.id.icon_d:
			intent = new Intent(this,ArgGisActivity.class);
			/*if(level == null || level.equals("") || level.equals("wgzrr")){
				...
				intent.putExtra(ArgGisActivity.GIS_KEY, ArgGisActivity.DRAW_POINT_FLAG);
				intent.putExtra(ArgGisActivity.GIS_DATA_KEY, myLatLon[0] + "!@" + myLatLon[1]);
			}else{*/
				intent = new Intent(this,EntInfoListActivity.class);
				intent.putExtra("listFlag",EntInfoListActivity.COMMUSERLIST_FLAG);
		...
		case R.id.icon_e:
			intent = new Intent(this,ArgGisActivity.class);
			intent.putExtra(ArgGisActivity.GIS_KEY, ArgGisActivity.DRAW_REG_FLAG);
			break;
		}
