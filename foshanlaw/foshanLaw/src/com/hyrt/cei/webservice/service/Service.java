...
public class Service {
	...
	public static String getUserListByuserId(String userid) {
		String rs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<ROOT>"
				+ "<userid>" + userid + "</userid>" + "</ROOT>";
		try {
			rs = agent.getUserListByuserId(rs);
		} catch (Exception e) {
			rs = "<?xml version='1.0' encoding='UTF-8'?>" + "<ROOT>"
					+ "<RETURNCODE>-1</RETURNCODE>" + "</ROOT>";
		}
	...
	public static String getUserListByuserId1(String userid) {
		String rs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<ROOT>"
				+ "<userid>" + userid + "</userid>" + "</ROOT>";
		try {
			rs = agent.getUserListByuserId1(rs);
		} catch (Exception e) {
			rs = "<?xml version='1.0' encoding='UTF-8'?>" + "<ROOT>"
					+ "<RETURNCODE>-1</RETURNCODE>" + "</ROOT>";
		}
	 ...
	 * 查询回查记录列表
	 */
	public static String queryCompanyByPatrolId(String id, int page) {
		String rs = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<ROOT>"
