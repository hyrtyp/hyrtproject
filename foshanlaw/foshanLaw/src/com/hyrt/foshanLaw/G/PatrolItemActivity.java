...
public class PatrolItemActivity extends Activity implements OnItemClickListener {
	...
	private void initView() {
		...
		textTop.setText("检查事项列表");
		TextView text1 = (TextView) findViewById(R.id.text1);
		text1.setText("问题");
		TextView text2 = (TextView) findViewById(R.id.text2);
		text2.setText("检查事项");
		Button leftBtn = (Button)findViewById(R.id.top_button_left);
		leftBtn.setText("表单记录");
		if(getIntent() != null && ("无证无照").equals(getIntent().getStringExtra("type"))){
		...
		leftBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(PatrolItemActivity.this,TablesActivity.class));
			}
		});
