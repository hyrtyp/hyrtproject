...
public class CommKey {
	...
	//ftp默认值
	public static final String ftp_default_ip = "192.168.1.10";
	...
	/*public static final String ftpuser="yepeng";
	public static final String ftppwd="889569";*/

	//服务器连接值
	public static final String server_default_ip = "192.168.1.10";
