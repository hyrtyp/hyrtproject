...
public class FileUtil {
    ...
    public static void iniLocalMap(String srcPath) throws IOException {
        // 源文件夹
        String url1 = srcPath;
        // 目标文件夹
        String url2 = "/mnt/sdcard/map";
        // 创建目标文件夹
    ...
    // 复制文件
    public static void copyFile(BufferedInputStream inBuff, File targetFile) throws IOException {
        BufferedOutputStream outBuff = null;
        try {
            // 新建文件输出流并对它进行缓冲
            outBuff = new BufferedOutputStream(new FileOutputStream(targetFile));
